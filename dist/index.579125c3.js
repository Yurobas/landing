    ...
    (function parallaxPlastic() {
        ...
        document.addEventListener('mousemove', (event)=>{
            ...
            requestAnimationFrame(()=>{
                requestAnimationFrame(()=>{
                    if (parallax.plastic.bg.el !== null) parallax.plastic.bg.el.style.transform = `translate3d(calc(-50% + ${parallax.plastic.bg.max * mod.x * -1}px), calc(-50% + ${parallax.plastic.bg.max * mod.y * -1}px), 1px)`;
                    if (parallax.plastic.obj.el !== null) parallax.plastic.obj.el.style.transform = `translate3d(${parallax.plastic.obj.max * mod.x * -1}px, ${parallax.plastic.obj.max * mod.y * -1}px, 1px)`;
                    if (parallax.stats.bg.el !== null) parallax.stats.bg.el.style.transform = `translate3d(calc(-50% + ${parallax.stats.bg.max * mod.x * -1}px), calc(-50% + ${parallax.stats.bg.max * mod.y * -1}px), 1px)`;
                    if (parallax.stats.first.el !== null) parallax.stats.first.el.style.transform = `translate3d(calc(-50% + ${parallax.stats.second.max * mod.x * -1}px), ${parallax.stats.second.max * mod.y * -1}px, 1px)`;
                    if (parallax.stats.second.el !== null) parallax.stats.second.el.style.transform = `translate3d(calc(-50% + ${parallax.stats.second.max * mod.x * -1}px + 50px), ${parallax.stats.second.max * mod.y * -1}px, 1px)`;
                });
            });
        });
    })();
